...
//        cell.amountLabel.text = "$\(transactions[indexPath.row].transactionAmount)"
    ...
    func dateFormat(_ cell: TransactionTableViewCell) {
        
        let formatter = DateFormatter()
        
        formatter.dateFormat = "MMM dd, yyyy"
        
        let dateString = formatter.string(from: transactionDate as Date)
