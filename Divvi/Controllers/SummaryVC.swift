...
//        amountLabel.text = transactionsTotalAtDate.toCurrency()
    ...
    private func setupCategoriesOnFirstLoad() {
        ...
        if categories.count == 0 {
            ...
            //Housing Category
            let mortgage = SubCategory()
            mortgage.subCategoryName = "Mortgage"
            mortgage.subCategoryAmountBudgeted = 0.0
            
            let rent = SubCategory()
            rent.subCategoryName = "Rent"
            rent.subCategoryAmountBudgeted = 0.0
            ...
            housingCategory.subCategories.append(mortgage)
            housingCategory.subCategories.append(rent)
